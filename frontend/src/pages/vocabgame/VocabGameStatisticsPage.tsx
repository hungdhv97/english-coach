...
import VocabGameStatistics from '@/features/vocabgame/components/VocabGameStatistics';
...
export default function GameStatisticsPage() {
  ...
  const {
    ...
    isLoading,
    error,
  } = vocabGameQueries.useSessionStatistics(sessionIdNum);
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 bg-gradient-to-br from-background to-muted/20">
      <div className="max-w-3xl mx-auto space-y-6">
        <VocabGameStatistics statistics={statistics} />
